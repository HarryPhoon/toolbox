...
@test "Try to remove a nonexistent container" {
  ...
  is "$output" "Container '$todelete' does not exist" "Toolbox should fail with: Container x does not exist"
}

@test "Try to remove the running container 'running'" {
  run_toolbox 1 rm running
  is "$output" "Container 'running' is running" "Toolbox should fail to remove the running container"
}
